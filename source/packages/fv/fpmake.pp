...
{$endif ALLPACKAGES}
    ...
    P.OSes := [beos,haiku,freebsd,darwin,iphonesim,solaris,netbsd,openbsd,linux,win32,win64,os2,emx,netware,netwlibc,go32v2,aix,dragonfly,ultibo]+AllAmigaLikeOSes;
    P.Email := '';
